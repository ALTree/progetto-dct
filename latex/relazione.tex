...
La funzione che opera il calcolo della IDCT2 è analoga a \texttt{dct2( )}. Per la creazione del piano è necessario passare come flag DCT \texttt{FFTW\_REDFT01} (che è l'inversa della \texttt{FFTW\_REDFT01} usata in precedenza per la DCT2).
