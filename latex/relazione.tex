...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.29]{images/flower_foveon.pdf} 
\caption{\texttt{flower\_feveon.bmp}, originale originale}
\end{figure}

\begin{figure}[!ht]
\centering
\includegraphics[scale=0.026]{images/flower_foveon_cut.pdf} 
